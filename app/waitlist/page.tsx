...
const steps = [
    {
        ...
        desc: "Tempo-speed performance with non-custodial security. Tempnomo connects your wallet to a high-speed house balance for instant execution without gas lag."
    },
    {
        id: "02",
...
const testimonials = [
    {
        ...
        content: "The Blitz Rounds are a game-changer. The millisecond precision from Pyth Oracles makes Tempnomo feel like a professional CEX but with decentralized peace of mind.",
    ...
    },
    {
        name: "Kai Zen",
        role: "Algo Developer",
        content: "Migrating to the Tempnomo protocol was the best move. Instant house balance settlement solves the on-chain latency issue perfectly for high-frequency binary options.",
        avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop"
    },
    {
        name: "Julian Vane",
        role: "Quant Trader",
        content: "Tempnomo's tiered system provides a clear roadmap for traders. The VIP perks and advanced indicators give us a significant edge in these fast-moving rounds.",
        avatar: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=200&auto=format&fit=crop"
    },
    {
        name: "Sarah M.",
        role: "Early Adopter",
        content: "Switching between Bitcoin and Gold predictions within seconds is what makes Tempnomo stand out. The multi-asset support is truly elite.",
...
const faqs = [
    {
        ...
        answer: "To ensure millisecond execution, Tempnomo uses a hybrid house balance system. You deposit AlphaUSD or BetaUSD into a non-custodial treasury on Tempo network, which is then reflected in your game balance."
    },
    {
        question: "What assets can I trade?",
        answer: "Tempnomo supports a wide range of assets including major cryptos (BTC, ETH, SOL), precious metals (Gold, Silver), and top-tier stocks (AAPL, NVDA, TSLA) through Pyth price feeds."
    },
    {
    ...
    },
    {
        ...
        answer: "Yes. All deposits are held in a secure treasury wallet verified on Tempo explorer. Withdrawals are processed through the Tempnomo protocol, ensuring you maintain ultimate control over your assets."
    }
];
    ...
    return (
        <main className="landing-layout selection:bg-purple-500/30">
            ...
            <nav className={`sticky-nav ${scrolled ? 'scrolled' : 'at-top'}`}>
                <div className="text-xl font-black tracking-tighter" style={{ fontFamily: 'var(--font-orbitron)' }}>TEMPNOMO</div>
            ...
            <section id="hero-top" className="min-h-screen justify-center">
                ...
                >
                    <div className="mb-10">
                        <TrueFocus
                            sentence="Tempnomo | The future is decentralized."
                            separator=" | "
                            manualMode={false}
                            blurAmount={12}
                            borderColor="#FF9FFC"
            ...
            <section className="bg-white/[0.01]">
                <div className="section-content">
                    <div className="text-center mb-32">
                        ...
                        <h2 className="text-6xl font-black tracking-tighter mb-8 bg-gradient-to-b from-white to-white/40 bg-clip-text text-transparent">How Tempnomo Works</h2>
            ...
            <footer className="py-24 px-10 border-t border-white/5 bg-black relative z-10 w-full overflow-hidden">
                <div className="huge-footer-logo">TEMPNOMO</div>
