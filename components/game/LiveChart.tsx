...
export const LiveChart: React.FC<LiveChartProps> = ({ betAmount, setBetAmount }) => {
  ...
  // Handle classic mode bet results at the graph tip
        ...
        {gameMode === 'classic' && scales && activeBets.map((bet: any) => {
          ...
          return (
            <g key={bet.id}>
              ...
              >
                {bet.direction} {bet.amount} αUSD {bet.strikePrice && `@ $${bet.strikePrice.toFixed(2)}`}
              </text>
            </g>
          );
        })}
                ...
                <div className="relative flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-lg font-bold ${result.won ? 'text-green-100' : 'text-red-100'}`}>
                      ...
                      <span className="text-xs ml-1 opacity-70">αUSD</span>
                    </p>
                  </div>
