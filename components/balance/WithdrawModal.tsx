...
export const WithdrawModal: React.FC<WithdrawModalProps> = ({
  ...
  const { address, withdrawFunds, houseBalance, refreshWalletBalance, selectedToken } = useOverflowStore();
  ...
  const handleWithdraw = async () => {
    ...
    try {
      ...
      toast.success(
        `Successfully withdrew ${withdrawAmount.toFixed(2)} ${currencySymbol}! Balance updated.`
      );
