...
export const MiniHistory: React.FC = () => {
    ...
    const currentToken = (state: any) => {
        const { TEMPO_TOKEN_LIST } = require('@/lib/tempo/config');
        return TEMPO_TOKEN_LIST.find((t: any) => t.address === selectedToken) || TEMPO_TOKEN_LIST[0];
    };
