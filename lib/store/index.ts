/**
 * Main Zustand store for Tempnomo dApp
 * Combines wallet, game, and history slices
 * 
 * Note: After Tempo migration, blockchain events are handled
 * via Tempo TIP-20 tokens. Game logic remains off-chain.
 */
...
export const initializeStore = async (): Promise<void> => {
  ...
  try {
    ...
    console.log("Tempnomo store initialized successfully");
  } catch (error) {
